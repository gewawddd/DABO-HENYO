...
export function SetupScreen({
  ...
  return (
    <main className="hsc-backdrop min-h-full w-full px-4 py-8 sm:px-8 sm:py-12 hsc-tv-stage">
      <div className="max-w-6xl mx-auto hsc-tv-max">
        <div className="lg:grid lg:grid-cols-[0.95fr,1.05fr] lg:gap-8 lg:items-start">
          <div className="space-y-6">
            <motion.div
              ...
              className="text-center mb-8 sm:mb-12 lg:text-left lg:mb-6">
            ...
            <motion.section
              ...
              className="hsc-glass-strong rounded-3xl p-5 sm:p-8"
